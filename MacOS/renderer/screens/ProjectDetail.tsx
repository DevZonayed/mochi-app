...
export function ChatThread({ projectId, project, sessionId, base, onSessionCreated, onOpenSession, onTurns, onOpenImage, onOpenFile, flush, autoFocus }: {
  ...
  // No plan-approval popup: the agent writes its plan to a Markdown file under
  // `.maestro/plans/` and asks for approval in chat. The operator turns the Plan
  // toggle off and replies to execute — no window events to sync.
