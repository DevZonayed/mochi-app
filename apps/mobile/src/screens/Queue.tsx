    ...
    <View style={{ flex: 1, backgroundColor: theme.color.bg }}>
      <ScrollView contentContainerStyle={{ paddingTop: insets.top + 4, paddingBottom: 30 }} showsVerticalScrollIndicator={false}>
        ...
        {queued.length === 0 && recurring.length === 0 ? (
          // First-run onboarding: surface the two example use-cases up front so a
          // new user understands what a "Queue" is for without reading the
          // ScheduleEditor first. Tapping any chip opens the editor pre-filled.
          <View style={{ paddingHorizontal: 20, paddingTop: 14 }}>
            ...
            {/* Tappable example cards — illustrate what a schedule looks like. */}
