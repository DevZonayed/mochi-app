...
interface RunReg { projectId: string | null; skills: boolean; bg: boolean; img: boolean; git?: GitCtx; images: CollectedImage[] }
interface RunOptions { skills?: boolean; bg?: boolean; img?: boolean; git?: GitCtx }
...
export class CodexBridge {
  ...
  register(projectId: string | null, opts: RunOptions = { skills: true, bg: true }): CodexRunRegistration {
    ...
    const reg: RunReg = { projectId, skills: !!opts.skills, bg: !!opts.bg, img: !!opts.img, git: opts.git, images: [] };
